...
/* this is my (mason edwards) main.jsx file for the classrooms list page, where I import my Classrooms.css file which has the blue color settings, as well as my classroomsData.json file, which has my mock data.
